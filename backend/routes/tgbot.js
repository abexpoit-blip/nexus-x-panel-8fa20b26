...
router.get('/config', (req, res) => {
  const keys = ['tg_public_channel', 'tg_otp_feed_chat', 'tg_required_group', 'tg_required_group_chat', 'tg_required_otp_group', 'tg_required_otp_group_chat', 'tg_terms_text'];
...
router.put('/config', (req, res) => {
  ...
  const allowed = ['tg_public_channel', 'tg_otp_feed_chat', 'tg_required_group', 'tg_required_group_chat', 'tg_required_otp_group', 'tg_required_otp_group_chat', 'tg_terms_text'];
  const stmt = db.prepare(`
